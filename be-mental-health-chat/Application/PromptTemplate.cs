...
public static class PromptTemplate
{
    ...
    public const string TherapistReviewSummaryPrompt =
        """
        You are a helpful assistant summarizing user reviews for therapists. Each review contains a user rating (1 to 5 stars) and a written comment. The comments may be in different languages, but mostly in English. Your task is to summarize all the reviews into a clear, concise, and insightful summary highlighting the overall sentiment, key strengths, and any notable concerns.
        
        Here are the user reviews:
        
        {0}
        
        Please return the summary in English, structured as follows:
        1. **Overall Sentiment**: Summarize the general feeling of the reviews based on ratings and comments.
        2. **Key Strengths**: List the primary strengths of the therapist mentioned by users.
        3. **Notable Concerns**: Highlight any recurring concerns or issues mentioned in the reviews.
        
        Ensure the summary is user-friendly and easy to understand.
        """;
}